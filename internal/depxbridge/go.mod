module github.com/projectdiscovery/depx/gogatozbridge

go 1.26.5

require github.com/projectdiscovery/depx v0.1.1

// Mirror depx v0.1.1's compatibility replacement. Dependency-module replace
// directives do not propagate to consumers.
